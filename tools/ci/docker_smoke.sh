...
# Substitute: hide-and-seek, coworld-hide-and-seek, 6.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-hide-and-seek:ci)
#   SMOKE_SLUG                 game slug                        (hide-and-seek)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/hide-and-seek)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/hide-and-seek-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-hide-and-seek:ci}}"
slug="${SMOKE_SLUG:-hide-and-seek}"
